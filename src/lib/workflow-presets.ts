...
export const STUDIO_CATEGORIES: StudioCategory[] = [
  {
    ...
    workflows: [
      ...
      },
      {
        id: "thumbnail-pack",
        name: "Thumbnail Pack",
        description: "Generate multiple thumbnail concepts",
        icon: Image,
        prompt: "Generate 4 different YouTube thumbnail concepts for a video about [topic]. Create each thumbnail image with different styles: bold text overlay, face closeup concept, before/after split, and clickbait curiosity gap.",
      },
      {
        id: "blog-post",
        name: "Blog Post Generator",
        description: "Research → Outline → Full post → SEO",
        icon: PenTool,
        prompt: "Research the topic [topic] and provide key insights. Then create a detailed blog post outline. Then write the full 2000-word blog post with SEO optimization. Then generate an SEO meta description and 10 relevant tags. Then export as a markdown file.",
      },
      {
      ...
      },
      {
        ...
        description: "Engaging captions with trending hashtags",
        icon: Hash,
        prompt: "Generate 10 engaging Instagram captions about [topic] with different tones (funny, inspirational, educational, provocative, storytelling). Then research and provide 30 relevant hashtags grouped by reach (high, medium, niche). Then create a hashtag strategy guide.",
      },
      {
        id: "podcast-episode",
        name: "Podcast Episode",
        description: "Topic → Script → Intro → Show notes",
        icon: Podcast,
        prompt: "Create a podcast episode plan about [topic]. Write a detailed episode script with intro, 3 main segments, and outro. Then generate show notes with timestamps. Then create a voice-over intro script. Then export the full script as a PDF.",
      },
    ],
  },
  {
